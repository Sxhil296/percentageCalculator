...
const SixthCalculator = () => {
  ...
  return (
    <>
      <div className="flex flex-col gap-2 border-2 border-black bg-[#FFC29F] p-2 rounded-md cursor-pointer hover:shadow-[8px_8px_0px_rgba(0,0,0,1)]">
...
export default SixthCalculator;
